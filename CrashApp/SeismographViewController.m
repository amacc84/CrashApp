...
#import "SeismographViewController.h"
...
@interface SeismographViewController ()
{
...
@implementation SeismographViewController
...
//sets layout orientation to fixed position//
...
-(IBAction)back:(id)sender{
    [motionManager stopAccelerometerUpdates];
    //error checking//
    NSLog(@"Stopped updating accelerometer data");
    //-------------//
}
