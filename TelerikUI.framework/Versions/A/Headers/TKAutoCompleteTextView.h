 ...
 */
@property (nonatomic, assign) NSUInteger maximumTokensCount;
...
/**
 ...
 @param handler Action which will be executed right after the filtration of the items.
 @return Array of the chosen completion suggestions
 */
-(NSArray<__kindof TKAutoCompleteToken*>*__nonnull)autoComplete:(TKAutoCompleteTextView*__nonnull)autocomplete completionsForString:(NSString *__nonnull)input completionHandler:(BOOL(^ __nullable)(NSArray*__nonnull))handler;
